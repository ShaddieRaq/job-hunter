...
## Current focus
- Active step: 6 (search/feed UI) while continuing Step 7 integration points
- Next PR target: implement web feed surfaces consuming `/v1/feed` and canonical detail with score + dedupe traces
