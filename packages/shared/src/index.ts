...
export {
  ...
  atsTargetVerificationEventIdSchema,
  atsTargetVerificationEventListResponseSchema,
  atsTargetVerificationEventSchema,
...
export type {
  ...
  AtsTargetVerificationEventId,
  AtsTargetVerificationEventListResponse,
